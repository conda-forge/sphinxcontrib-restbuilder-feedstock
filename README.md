About sphinxcontrib-restbuilder-feedstock
=========================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinxcontrib-restbuilder-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3574&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinxcontrib-restbuilder-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinxcontrib-restbuilder` can be installed with `conda`:
...
```
mamba install sphinxcontrib-restbuilder
```

It is possible to list all of the versions of `sphinxcontrib-restbuilder` available on your platform with `conda`:
...
```
mamba search sphinxcontrib-restbuilder --channel conda-forge
```
...
mamba repoquery search sphinxcontrib-restbuilder --channel conda-forge

# List packages depending on `sphinxcontrib-restbuilder`:
mamba repoquery whoneeds sphinxcontrib-restbuilder --channel conda-forge

# List dependencies of `sphinxcontrib-restbuilder`:
mamba repoquery depends sphinxcontrib-restbuilder --channel conda-forge
```
